...
from routes.router import home_blue_print, cadastro_especialidade_blue_print, cadastro_medicos_blue_print, cadastro_horarios_blue_print, listar_especialidades_blue_print,deletar_especialidade_blue_print
